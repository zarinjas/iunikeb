    ...
    <PublicLayout>
        <section class="py-12">
            <div class="mx-auto max-w-3xl px-4">
                <Button :as="Link" href="/pengumuman" variant="outline" class="mb-6 w-fit">
                ...
                <article class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                    <div v-if="announcement.image_url" class="-mx-6 -mt-6 mb-6 overflow-hidden rounded-t-3xl">
                        <img :src="announcement.image_url" :alt="announcement.title" class="w-full max-h-64 object-cover">
                    </div>
