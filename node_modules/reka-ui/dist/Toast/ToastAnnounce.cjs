...
var ToastAnnounce_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return (0, vue.unref)(isAnnounced) || renderAnnounceText.value ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_VisuallyHidden_VisuallyHidden.VisuallyHidden_default), {
				key: 0,
