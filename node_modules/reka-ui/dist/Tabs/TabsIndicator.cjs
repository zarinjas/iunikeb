...
var TabsIndicator_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return (0, vue.unref)(isMounted) && typeof indicatorStyle.value.size === "number" ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(require_Primitive_Primitive.Primitive), (0, vue.mergeProps)({ key: 0 }, props, { style: {
